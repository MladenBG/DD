...
export const UserDashboard = ({ myName, myCity, isVip, setShowPaywall, openEditProfile }: any) => {
  return (
        ...
        <View className="px-5 mt-6">
          ...
          <View className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
            <TouchableOpacity className="flex-row items-center justify-between p-5 border-b border-gray-100" onPress={openEditProfile}>
              <View className="flex-row items-center"><Text className="text-[20px] mr-4">👤</Text><Text className="text-[16px] font-bold text-gray-900">Edit Profile Info</Text></View>
              <Text className="text-gray-400 font-bold">›</Text>
            </TouchableOpacity>
            <TouchableOpacity className="flex-row items-center justify-between p-5 border-b border-gray-100">
              <View className="flex-row items-center"><Text className="text-[20px] mr-4">🛡️</Text><Text className="text-[16px] font-bold text-gray-900">Privacy & Safety</Text></View>
              <Text className="text-gray-400 font-bold">›</Text>
            </TouchableOpacity>
            <TouchableOpacity className="flex-row items-center justify-between p-5">
              <View className="flex-row items-center"><Text className="text-[20px] mr-4">⚙️</Text><Text className="text-[16px] font-bold text-gray-900">App Preferences</Text></View>
              <Text className="text-gray-400 font-bold">›</Text>
            </TouchableOpacity>
          </View>
        </View>
